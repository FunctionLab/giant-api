...
print "This script uses the GIANT API to run a NetWAS job in demo mode, which is"
print "invoked by the setting \"tissue=api-demo\". This simulates a short SVM training,"
print "which completes in under 2 minutes. In order to run NetWAS on actual tissues,"
print "please replace \"api-demo\" with one of the 144 tissue choices supported by the"
print "API. Valid options are listed at http://giant-api.princeton.edu/tissues. Note"
print "that non-demo NetWAS tasks may take up to 30 minutes to complete.\n"
...
# End demo
print "Job status and results are also accessible from the web interface of the API."
print "Please visit:\n"
